...
import { useNavigate } from 'react-r            <button className="btn btn-outline" onClick={() => navigate('/login')}>
...
export default Header;onst Header = ({ isLoggedIn, currentUser, userRole, handleLogout, setCurrentView, currentView, handleBack, onProfileClick }) => {
